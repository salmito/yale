...
public class MainCamera {
	...
	public void lookAt() {
		Matrix.setLookAtM(MainRenderer.mViewMatrix, 0, eye[0], eye[1], eye[2], look[0], look[1], look[2], up[0], up[1], up[2]);
	}
	...
	public float [] unproject(float x,float y) {
		...
		GLU.gluUnProject(x, MainRenderer.mView[3]-y, 0.0f, MainRenderer.mViewMatrix,  0, MainRenderer.mProjectionMatrix, 0, MainRenderer.mView, 0, objCoordsnear, 0);
		GLU.gluUnProject(x, MainRenderer.mView[3]-y, 1.0f, MainRenderer.mViewMatrix,  0, MainRenderer.mProjectionMatrix, 0, MainRenderer.mView, 0, objCoordsfar, 0);
